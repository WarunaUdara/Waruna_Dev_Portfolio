...
const Footer = () => {
  return (
    <div className="w-full bg-black text-white py-8 px-4 sm:px-8 md:px-16 lg:px-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center py-8">
        ...
        <div className="mb-6 md:mb-0">
          <h2 className="text-2xl font-bold">Waruna Udara</h2>
        ...
        <div className="grid grid-cols-2 gap-x-12 gap-y-6">
          ...
          <div>
            <h3 className="text-lg font-medium mb-3">The Website</h3>
            <ul className="space-y-2">
